...
- 优先使用 text_search 进行搜索，search_symbol 需要项目已索引

例如：
Thought: 我需要检查认证相关的代码，先搜索登录相关内容
Action: text_search
Action Input: {{"query": "login"}}

或者：
Thought: 我需要读取配置文件
Action: read_file
Action Input: {{"file_path": "src/main.rs"}}
